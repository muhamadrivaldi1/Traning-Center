    ...
    <div>
      ...
      <section id="jadwal" className="schedule-section">
        ...
        <div className="schedule-grid">
          {[
            { image: "tweb.jpeg", title: "Web Development", description: "Belajar membangun website modern dengan teknologi terkini seperti HTML, CSS, JavaScript, dan framework populer." },
            { image: "tuiux.jpeg", title: "UI / UX Design", description: "Desain antarmuka yang efektif dan pengalaman pengguna yang menarik menggunakan tools desain profesional." },
            { image: "tcyber.jpeg", title: "Cyber Security", description: "Pelajari teknik keamanan sistem dan jaringan untuk melindungi data dan infrastruktur digital." },
            { image: "tdatascience.jpeg", title: "Data Science", description: "Teknik pengolahan data dan analisis menggunakan Python, R, dan machine learning algorithms." },
            { image: "tmobile.jpeg", title: "Mobile Development", description: "Pengembangan aplikasi mobile untuk platform Android dan iOS dengan React Native dan Flutter." },
            { image: "jadwal6.jpeg", title: "Artificial Intelligence", description: "Pengenalan konsep AI, machine learning, dan deep learning untuk aplikasi praktis." }
          ].map((training, index) => (
